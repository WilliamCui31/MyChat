...
class InnerCometChatUserProfile extends React.Component {
	constructor(props) {
		super(props);
...
InnerCometChatUserProfile.defaultProps = {
	lang: Translator.getDefaultLanguage(),
	theme: theme,
};

InnerCometChatUserProfile.propTypes = {
...
const  CometChatUserProfile = connect(null, mapDispatchToProps)(InnerCometChatUserProfile);
