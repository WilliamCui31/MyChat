  ...
  render() {
    ...
    return (
      ...
      <div css={wrapperStyle()}>
          ...
          {loader}
          {errorMessage}
          <p css={titleStyle()}>My Chat App</p>
          <p css={subtitleStyle()}>Login with one of our sample users</p>
          <div css={userContainerStyle()}>
            <div css={userWrapperStyle()} onClick={()=>this.login('williamcui')}>
              <div css={thumbnailWrapperStyle()}>
                <CometChatAvatar image='https://avatars.githubusercontent.com/u/12391263?s=40&v=4' />
              </div>
              <p>William Cui</p>
            </div>
